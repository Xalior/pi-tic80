...
//     tic80-defaults.ld pins to image offset 0x800. It ships with the
...
#ifdef __ELF__
__asm__ (
    "\t.section .tic80.entry, \"ax\", %progbits\n"
    "\t.globl _tic80_entry\n"
    "_tic80_entry:\n"
    "\tb _start\n"
    "\t.previous\n"
...
#define DEFAULTS_BLOCK_PLACEMENT \
    __attribute__ ((section (".tic80.defaults"), used, aligned (8)))
#else
...
TDefaultsBlock _tic80_defaults =
{
